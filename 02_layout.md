...
6. Go to the Item Properties tab on the right side and scroll down to *Position and Size*. Alter this to any dimensions you want your image to be (you can change the measure to pixels if it's for web). You can also use the *Main Properties* area at the top to see what the current scale is, and change that to a simpler rounded number.
