...
6. Go to the Item Properties tab on the right side and scroll down to *Position and Size*. Alter this to any dimensions you want your image to be (change the measure to pixels if it's for web: we are going to use 1200px x 795px). *Make a note of these numbers because you may need it for any code later*
